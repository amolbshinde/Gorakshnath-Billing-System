    ...
    class purchasedetailsDAL
    {
        ...
        public bool insertpurchasedetails(purchasedetailsBLL st)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO Purchase_Transaction_Details(Purchase_ID,Product_ID,Sup_ID,Product_Name,Unit,Qty,Purchase_Prise,Discount_Per,GST_Type,GST_Per,Total) VALUES(@Purchase_ID,@Product_ID,@Sup_ID,@Product_Name,@Unit,@Qty,@Purchase_Prise,@Discount_Per,@GST_Type,@GST_Per,@Total)";
                ...
                cmd.Parameters.AddWithValue("@Purchase_Prise", st.Purchase_Prise);
